                    ...
                    {extracted && (
                        <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 flex justify-between items-center group">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    onClick={() => {
                                        const clusterMatch = result?.match(/(Proteína|Carbohidratos|Grasas|Vegetales|Ultraprocesados|Otros)/i);
                                        const cluster = (clusterMatch?.[0] || 'Otros') as any;
                                        actions.addToPantry({
                                            ...extracted as FoodItem,
                                    ...
                                    disabled={saved}
                                    title="Añadir a Mi Stock"
                                    className={`size-12 rounded-2xl flex items-center justify-center transition-all ${saved ? 'bg-slate-900 text-white' : 'bg-white shadow-sm border border-slate-200 text-slate-400 hover:text-slate-900'}`}
                                >
